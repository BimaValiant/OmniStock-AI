...
<body class="bg-slateBg text-slate-300 antialiased font-sans min-h-screen flex selection:bg-slate-700 selection:text-white">
    ...
    <!-- SIDEBAR -->
    <aside class="w-64 bg-[#0B0E17] border-r border-slateBorder/60 p-5 flex flex-col justify-between hidden md:flex shrink-0">
        <div>
            <div class="flex items-center gap-3 mb-8">
                <div class="w-7 h-7 rounded bg-slate-700/50 border border-slate-600/40 flex items-center justify-center text-slate-300 font-bold text-xs">
                    Cn
                </div>
                <div>
                    <h2 class="font-headline font-bold text-white text-sm tracking-tight leading-none">OmniStock AI</h2>
                    <span class="text-[10px] text-slate-500 font-medium tracking-wider">Enterprise Command</span>
                </div>
            </div>

            <nav class="space-y-1.5">
                <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-slateActive text-white font-medium text-xs shadow-sm">
                ...
                <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-slateCard text-xs font-medium transition">
        ...
        <div class="pt-6 border-t border-slateBorder/60 space-y-2">
            <a href="#" class="flex items-center gap-3 px-3 py-1.5 text-slate-400 hover:text-slate-200 text-xs font-medium">Support</a>
            <a href="#" class="flex items-center gap-3 px-3 py-1.5 text-slate-400 hover:text-slate-200 text-xs font-medium">Log Out</a>
            <div class="flex items-center justify-center gap-2 p-2 bg-slateCard/80 rounded-lg border border-slateBorder mt-3">
                <span class="text-xs">👤</span>
                <span class="text-xs font-semibold text-slate-200">User Profile</span>
            </div>
        </div>
    </aside>
    ...
    <main class="flex-1 p-6 md:p-8 overflow-y-auto">
        ...
        <!-- TOP HEADER / NAVBAR (DENGAN INPUT LIVE SEARCH) -->
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <button onclick="openModal('recordSaleModal')" class="bg-[#18202F] border border-slateBorder hover:bg-slate-800 text-slate-300 text-xs font-medium px-3.5 py-1.5 rounded-lg transition flex items-center gap-1.5">
        ...
        <!-- BOTTOM SECTION: STOCK STATUS TABLE (DYNAMIC DATA) -->
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-xs text-slate-300">
                    ...
                    <tbody class="divide-y divide-slateBorder/40">
                        ...
                        @empty
                        <!-- Mock Rows fallback jika DB kosong -->
                        <tr class="hover:bg-slate-800/20">
    ...
    <!-- FLOATING AI CHAT WIDGET (FIXED POSITIONING MELAYANG DI ATAS TOMBOL) -->
    <div class="fixed bottom-8 right-8 z-50">
        ...
        <!-- Chat Box Window (Posisi di atas tombol: bottom-full mb-3) -->
    ...
    <script>
        ...
        document.getElementById('addProductForm').addEventListener('submit', async (e) => {
            ...
            if(res.ok) { closeModal('addProductModal'); location.reload(); }
        });
        ...
        document.getElementById('recordSaleForm').addEventListener('submit', async (e) => {
            ...
            if(res.ok) { closeModal('recordSaleModal'); location.reload(); }
        });
    </script>
</body>
</html>